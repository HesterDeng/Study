 ...
 */
@ServerEndpoint(value = "/ws/logun")
@Component
public class logunSocket extends websocketbase implements IMonitorSubject {
    // 静态变量,监控的资源对象
    public static int onlineCount = 0;
    // 存放在线用户的链接socket。
    public static CopyOnWriteArrayList<logunSocket> logunSocketSet = new CopyOnWriteArrayList<>();
    // 存放订阅者(观察者)
    ...
    public static void sendInfo(String message) {
        for (logunSocket item : logunSocketSet) {
            try {
